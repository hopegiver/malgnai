<template>
  <div>
    ...
    <ul class="nav nav-tabs mb-3">
      ...
      <li class="nav-item">
        <a class="nav-link" :class="{ active: tab === 'usage' }" href="#" @click.prevent="tab = 'usage'">
          <i class="bi bi-search me-1"></i>토큰 범인
        </a>
      </li>
      <li class="nav-item">
    ...
    <div v-if="tab === 'stats'">
      <div class="card">
        <!-- Chart Area -->
        <div class="p-3 border-bottom" style="height: 200px; position: relative;">
          <div class="d-flex align-items-end justify-content-center gap-1" style="height: 100%;">
            <div v-for="s in statsChart" :key="s.date" class="d-flex flex-column align-items-center" style="flex: 1; max-width: 32px;">
    ...
    <div v-if="tab === 'tokens'">
      ...
      <div class="card mb-3">
        ...
        <div class="p-3 border-bottom" style="height: 200px; position: relative;">
          <div class="d-flex align-items-end justify-content-center gap-1" style="height: 100%;">
            <div v-for="t in tokensChart" :key="t.date" class="d-flex flex-column align-items-center" style="flex: 1; max-width: 32px;">
    ...
    <div v-if="tab === 'usage'">
      ...
      <div class="row g-3">
          ...
          <div class="card">
            ...
            <div class="table-responsive">
              <table class="table table-sm mb-0 small">
                <thead><tr><th>세션 / 제목</th><th class="text-end">응답</th><th class="text-end">서브</th><th class="text-end">토큰</th><th class="text-end">비용</th></tr></thead>
                <tbody>
                  ...
                  <tr v-if="!usageSessions.length"><td colspan="5" class="text-center text-muted p-3">데이터 없음</td></tr>
                </tbody>
              </table>
            </div>
          </div>
        ...
        <div class="col-lg-5">
          <div class="card mb-3">
            <div class="p-3 border-bottom fw-bold small">서브에이전트 type별 (범인)</div>
            <div class="table-responsive">
              <table class="table table-sm mb-0 small">

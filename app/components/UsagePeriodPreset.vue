 ...
 * (app/pages/usage/[id].vue)이 "오늘"의 정의(브라우저 로컬 캘린더 기준, utils.js isoDaysAgo())를
 * 어긋나지 않게 같은 소스로 공유한다(docs/api.md §5.8.0, docs/design/usage-kst-day-boundary.md §7).
 * 기존 app/pages/usage.vue는
